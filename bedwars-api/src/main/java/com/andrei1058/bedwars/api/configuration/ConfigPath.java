...
public class ConfigPath {
    ...
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_PATH = GENERAL_FIREBALL_PATH + ".destory-blocks";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_STATE = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".enable";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_RADIUS = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".destruction-radius";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_REVERSE_WHITELIST = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".reverse-whitelist";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_ALLOW_DESTRUCTION = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".allow-destruction";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_DESTORY_ORIGINAL_BLOCKS = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".destory-original-blocks";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_SPAWN_PROTECTION = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".spawn-protection";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_SHOP_PROTECTION = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".shop-protection";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_UPGRADES_PROTECTION = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".upgrades-protection";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_GENERATOR_PROTECTION = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".generator-protection";
    public static final String GENERAL_FIREBALL_DESTORY_BLOCKS_GENERATE_EXPLOSIVE_PARTICLES = GENERAL_FIREBALL_DESTORY_BLOCKS_PATH + ".generate-explosive-particles";
