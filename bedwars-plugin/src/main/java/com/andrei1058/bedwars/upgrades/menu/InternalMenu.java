...
public class InternalMenu implements UpgradesIndex {
    ...
    public void open(Player player) {
        ...
        Inventory inv = Bukkit.createInventory(null, UpgradesManager.getConfiguration().getInt("inv-slots"), Language.getMsg(player, Messages.UPGRADES_MENU_GUI_NAME_PATH + name));
